...
export const authReducer =(state=initialState,action)=>{
    ...
    switch (action.type){
        ...
        case ADD_TO_FAVORITE_SUCCESS:
            return{...state, isLoading:false,error:null, favorites:isPresentInFavorites(state.favorites,action.payload)? state.favorites.filter((item)=>item.id == action.payload.id)
