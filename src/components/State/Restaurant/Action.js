...
export const createRestaurant =(reqData)=>{
    ...
    return async (dispatch) =>{
        dispatch({type:CREATE_RESTAURANT_REQUESTs});
        try{
...
export const updateRestaurant =({restaurantId, restaurantData, jwt})=>{
    ...
    return async (dispatch) =>{
        ...
        try{
            ...
            dispatch({type:UPDATE_RESTAURANT_STATUS_FAILUR,payload:error});
            console.log("error",error);
        }
    };
};
...
export const updateRestaurantStatus =({ restaurantId, jwt})=>{
    return async (dispatch)=>{
        dispatch({type:UPDATE_RESTAURANT_STATUS_REQUEST})
        try{
            const res = await api.delete(`/api/admin/restaurant/${restaurantId}/status`,{
                headers:{
                    Authorization:`Bearer ${jwt}`,
                },
            });
...
export const RestaurantCategory =({  jwt,restaurantId})=>{
    return async (dispatch)=>{
